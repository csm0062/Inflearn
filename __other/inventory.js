...
// 인벤토리에 특정 아이템이 모두 있는지 확인하고, 있으면 아이템을 무대로 옮기는 함수
function checkInventoryAndMoveItems() {
    const requiredItems = [
        '../image/images/useritem/반지.png',
        '../image/images/useritem/쟁미.png',
        '../image/images/useritem/깨진액자.png',
        '../image/images/useritem/심장.png'
    ];
    ...
    if (allItemsPresent) {
        alert('무대로 가보자');
        // 무대로 아이템### 수정된 HTML, CSS, JavaScript 코드